...
def decode(input_file):
    with open(input_file,"rb") as f:
        ...
        while(True):
            ...
            if not hunk_size:
                break
            print("Hunk #{}, offset ${:06x} type ${:04x} ({}), size ${:x}".format(i,f.tell()-8,hunk_type,hunk_dict.get(hunk_type,str(hunk_type)),hunk_size))
            i+=1
...
decode(r"K:\jff\AmigaHD\PROJETS\HDInstall\DONE\T\TFXHDDev\data\tfx.040_orig_nw")
